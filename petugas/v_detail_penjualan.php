        ...
        <table class="table table-dark table-striped">
              ...
              <tr>
                ...
                <td>
                  <form action="m_hapus_detail_barang.php" method="post">
                    <input type="hidden" name="id_detail_penjualan" value="<?= $detail['id_detail_penjualan'] ?>">
                    <input type="hidden" name="id_pelanggan" value="<?= $pelanggan['id_pelanggan'] ?>">
                    <input type="submit" value="Hapus" class="btn btn-outline-light">
                  </form>
                </td>
              </tr>
          <?php   }
          ...
          <form action="m_hitung_total.php" method="post">
            ...
            <tr>
              ...
              <td colspan="2"></td>
              <td>Total</td>
              <td><input type="number" name="total" id="total"  value="<?= $total['Total'] ?>" readonly></td>
              <td colspan="2"></td>
            </tr>
            <tr>
              <td colspan="2"></td>
              <td>Bayar</td>
              <td><input type="number" name="bayar" id="bayar" onchange="this.form.submit()" tabindex="2"></td>
              <td colspan="2"></td>
            </tr>
            <tr>
              <td colspan="2"></td>
